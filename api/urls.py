...
from .views import  CommentThreadPIView, CommentVoteAPIView, CreateUserView, ProfileAPIView, ProfileViewSets, ThreadAPIView,VoteAPIView,VoteDetailAPIView
...
urlpatterns = [
  ...
  path("thread/comment",CommentThreadPIView.as_view(),name="commentThread"),
