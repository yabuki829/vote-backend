# Generated by Django 4.1 on 2022-09-24 04:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='thread',
            name='vote',
            field=models.ManyToManyField(blank=True, to='api.vote'),
        ),
        migrations.CreateModel(
            name='Choice',
            fields=[
                ...
                ('vote', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='api.vote')),
                ('votedUserCount', models.ManyToManyField(blank=True, to='api.profile')),
            ],
        ),
    ]
